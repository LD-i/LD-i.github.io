<template>
	<div class="lrcContainer">
		<div class="lrc" ref="lrc">
			...
			<p
			class="lrc-p"
			:class="{active:parseFloat(currentTime) >= keyArr[index] && parseFloat(currentTime) < keyArr[index+1]}"
...
<script>
	export default{
		...
		mounted(){
			const httpurl=this.HOST+"/v1/restserver/ting?method=baidu.ting.song.lry&songid="+this.songid;
